...
@ComponentScan({
	"com.mourity.OrderManagmentSystem.springMVCAndDataJPA"
})
@EnableJpaRepositories(basePackages = "com.mourity.OrderManagmentSystem.springMVCAndDataJPA.repository")
public class AppContext {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactoryBean.setPackagesToScan(new String[] {
				"com.mourity.OrderManagmentSystem.springMVCAndDataJPA.entity"
		});
